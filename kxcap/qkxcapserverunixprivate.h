...
#ifndef QKXCAPSERVERUNIXPRIVATE_H
#define QKXCAPSERVERUNIXPRIVATE_H
...
class QKxCapServerUnixPrivate : public QKxCapServerPrivate
{
    Q_OBJECT
public:
    explicit QKxCapServerUnixPrivate(const QString& envName, const QString &host, quint16 port);
...
#endif // QKXCAPSERVERUNIXPRIVATE_H
